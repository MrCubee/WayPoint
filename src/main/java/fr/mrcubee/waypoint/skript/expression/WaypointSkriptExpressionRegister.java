...
public class WaypointSkriptExpressionRegister {
    ...
    public static void register() {
        Skript.registerExpression(SkGetPlayerWaypointExpression.class, WayPoint.class, ExpressionType.COMBINED, "get %player%['s] waypoint[s]", "get %player%['s] %string% waypoint");
